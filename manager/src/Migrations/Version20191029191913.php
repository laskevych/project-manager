 ...
 */
final class Version20191029191913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_user_networks (id UUID NOT NULL, user_id UUID NOT NULL, network VARCHAR(32) NOT NULL, identity VARCHAR(1024) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_users (id UUID NOT NULL, date DATE NOT NULL, email VARCHAR(255) DEFAULT NULL, password_hash VARCHAR(255) DEFAULT NULL, confirm_token VARCHAR(255) DEFAULT NULL, status VARCHAR(16) NOT NULL, role VARCHAR(255) NOT NULL, reset_token_token VARCHAR(255) DEFAULT NULL, reset_token_expires DATE DEFAULT NULL, PRIMARY KEY(id))');
